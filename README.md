...
### スラッシュコマンド（結果は自分だけに表示）

| コマンド | 説明 |
|---|---|
| `/hist-search キーワード` | キーワード検索（エフェメラル表示） |
| `/hist-search from:@ユーザー キーワード` | ユーザーで絞り込み検索 |
| `/hist-search date:2024-01-01 キーワード` | 日付で絞り込み検索 |
| `/thread 123` | スレッド #123 の全文を表示 |
